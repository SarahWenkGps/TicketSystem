        ...
        for (let index = 0; index < res.data.data.length; index++) {
          let obj = {
           ...
           />
            ...
            ></i>),
            log:(  <div className='dep_icons'  > <div className='iconUserDialog' onClick={()=>{window.location=`/LogTable?id=${res.data.data[index].task_type_id}&name=${"type"}`}}   >   <img src={require('../../assets/img/log.png')} alt='img' style={{height:25}} /></div></div> )
          };
          arr.push(obj);
